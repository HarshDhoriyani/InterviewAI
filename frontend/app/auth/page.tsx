...
function AuthForm() {
  ...
  // ── Only redirect AFTER isLoading is false ──────────────────────────────
  // This prevents the flash-redirect bug where isAuthenticated is briefly
  // false on first render (before localStorage is read).
  useEffect(() => {
  ...
  // While checking auth, show spinner instead of the form
  if (isLoading) {
    return (
